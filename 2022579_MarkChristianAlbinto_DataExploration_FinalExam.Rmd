...
# Create a sequence of numbers from 1 to the length of the months vector
months_ordinal_values <- 1:length(months)

# Combine the ordinal values with the months into a data frame
...
```{r}
df_forest_fire$months_ordinal <- forest_fire_months_ordinal
...
```{r}
df_forest_fire$days_ordinal <- forest_fire_days_ordinal
